    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when(intent.getIntExtra("dia", 1)){
            ...
            1 -> {
                ...
                exercisesList.add(DataModel("Euro Step.","Empiezo dribleando desde fuera de la pintura  y hago un eurostep. Primero con el primer paso corto, y el segundo largo; luego con ambos pasos largos.", "15 euro steps por lado" , R.drawable.placeholdergif))
            }
            2 -> {
