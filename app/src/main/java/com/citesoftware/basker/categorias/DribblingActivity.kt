...
class DribblingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when(intent.getIntExtra("dia", 1)){
            ...
            1 -> {
                exercisesList.add(DataModel("Dribble en V Frontal","Con las rodillas flexionadas y mirando al frente, dribbleo de lado a lado frontalmente. Aumento la velocidad Y fuerza tanto como pueda.", "3 series de 20 dribbles por cada mano." , R.drawable.placeholdergif))
            ...
            2 -> {
                exercisesList.add(DataModel("Dribble en V Lateral","Con las rodillas flexionadas y mirando al frente, dribbleo de adelante hacía atrás lateralmente. Aumento la velocidad Y fuerza tanto como pueda.", "3 series de 20 dribbles por cada mano." , R.drawable.placeholdergif))
            ...
            3 -> {
                exercisesList.add(DataModel("Dribbling estacionario", "Con las rodillas flexionadas y mirando al frente, pico la pelota verticalmente aumentando la velocidad y la fuerza tanto como pueda." , "3 series de 60 segundos por mano." , R.drawable.placeholdergif))
